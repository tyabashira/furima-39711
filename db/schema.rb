...
ActiveRecord::Schema[7.0].define(version: 2023_09_18_132032) do
  ...
  create_table "furimas", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["item_id"], name: "index_furimas_on_item_id"
  ...
  create_table "shoppings", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["furima_id"], name: "index_shoppings_on_furima_id"
  end
  ...
  add_foreign_key "furimas", "items"
  add_foreign_key "furimas", "users"
  add_foreign_key "items", "users"
  add_foreign_key "shoppings", "furimas"
end
